define([
	...
	'dojo/number',
	'dojo/i18n'
], function (registerSuite, assert, array, number) {
	...
	registerSuite({
		...
		'ICU4J Regressions': {
			...
			'1': function() { // NumberFormatRegressionTest.Test4161100
				checkFormatParseCycle({ pattern: '#0.#', locale: 'en-us' }, -0.09, '-0.1', false);
			}, 

			'3': function() { // NumberRegression.Test4087535, NumberRegression.Test4243108
			...
			'4': function() { // NumberRegression.Test4088503, NumberRegression.Test4106658
			...
			'6': function() { // NumberRegression.Test4086575
				var locale = 'fr';
				var pattern = '###.00;(###.00)';
			...
			'8': function() { // NumberRegression.Test4092480, NumberRegression.Test4074454
			...
			'9': function() { // NumberRegression.Test4052223
			...
			'10': function() { // NumberRegression.Test4125885
